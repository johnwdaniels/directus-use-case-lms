...
export function mapLesson(raw: UnknownRecord): Lesson {
  return {
    ...
    required: raw.required == null ? null : Boolean(raw.required),
    completion_criteria: raw.completion_criteria != null ? String(raw.completion_criteria) : null,
    ...
    allow_download: raw.allow_download == null ? null : Boolean(raw.allow_download),
...
export function mapToCourse(raw: UnknownRecord): Course {
  return {
    ...
    visibility: raw.visibility != null ? String(raw.visibility) : null,
